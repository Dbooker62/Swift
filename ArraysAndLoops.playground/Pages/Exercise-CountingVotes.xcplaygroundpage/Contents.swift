...
if countYes > countNo {
    print("The votes have passed.")
} else {
    print("The vote has failed.")
}

var countCoffeeYes = 0
var countCoffeeNo = 0
var countPollYes = 0
var countPollNo = 0
...
if countCoffeeYes > countCoffeeNo {
    print("The votes have passed.")
} else if  countCoffeeYes < countCoffeeNo {
    print("The vote has failed.")
}
else
{
 print("The vote has draw.")
}
if countPollYes > countPollNo {
    print("There will be polls.")
} else if  countPollYes < countPollNo {
    print("There will not be polls.")
}
else
{
    print("The poll are draw.")
}
/*:
 ### Extension:
...
func voteCounter(votes: [Bool]) -> String {
    var countYes = 0
    var countNo = 0
